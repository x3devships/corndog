...
uint256 public constant DAO_TOKENS_IN_LP3 = 45;
    ...
    $("#detail-tab-A").html(`
    <h4>
    LP1 Balance: ${lp1_balance}<br />
    LP2 Balance: ${lp2_balance}<br />
    LP3 Balance: ${lp3_balance}<hr />
    LP1 Voucher Balance: ${lp1_voucher_balance}<br />
    LP2 Voucher Balance: ${lp2_voucher_balance}<br />
...
const wallet_connected = (wallet_address) => {
    console.log("wallet_connected");
    let content = `
        <section id="metamask_connect">
        <center>
            Connected to ${wallet_address}<br /><br />
        </center>
        </section>

  <article role="tabpanel" id="detail-tab-A">
    <h3>Loading...</h3>
  </article>
    `;
